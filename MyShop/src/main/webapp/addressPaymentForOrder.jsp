...
<title>Add Payment Address</title>
<script>
...
<div class="right-div">
<h3>Pay online on this admin@gmail.com</h3>
 <input class="input-style" type="text" name="transactionid"  placeholder="Enter Traction ID" >
