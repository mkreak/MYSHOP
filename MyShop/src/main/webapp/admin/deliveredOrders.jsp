...
<table id="customers">
        ...
        try{
        	...
        	ResultSet rs=st.executeQuery("select * from cart inner join product where cart.product_id=product.pid and cart.orderdate is not NULL and cart.status='delivered'");
        	while(rs.next()){
